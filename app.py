...
def overview():
    ...
    return jsonify(
        ...
        archive=qa("SELECT * FROM activity WHERE area='archive' ORDER BY id DESC LIMIT 5"),
        access=qa("SELECT * FROM activity WHERE area IN ('viewers','settings') ORDER BY id DESC LIMIT 5"))
